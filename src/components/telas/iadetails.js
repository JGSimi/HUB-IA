...
function IADetails() {
    ...
    return (
        <div className="p-8 ml-20">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6">
                    <div className="flex items-center gap-6 mb-6">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-gray-800">{ferramenta.nome}</h1>
                    ...
                    <div className="grid grid-cols-3 gap-6">
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg">
                            <h2 className="text-xl font-semibold mb-3">Informações Técnicas</h2>
            ...
            <div className="mt-8 bg-gray-50 p-6 rounded-lg">
                <h2 className="text-2xl font-semibold mb-4">Avaliações da Comunidade</h2>
                <div className="flex flex-col gap-4">
                    <div className="bg-white p-4 rounded-lg shadow-sm">
