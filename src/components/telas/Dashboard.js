...
function Dashboard() {
    ...
    return (
        <div ref={gradientRef} className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50">
                        ...
                        {ferramentasOrdenadas
                            ...
                            .map((ferramenta) => (
                                <div key={ferramenta.id} 
                                    className={`bg-white rounded-xl shadow-sm hover:shadow-gray-200 hover:shadow-md hover:font-bold hover:text-xl hover:bg-gradient-to-r from-blue-100 to-purple-200 transition-all duration-300 overflow-hidden ${
                                    ...
                                    <div className="p-6 flex flex-col justify-between h-full">
                                        ...
                                        <a
                                            ...
                                            className="block w-full text-center px-6 py-3 bg-gradient-to-r from-blue-400 to-blue-700 text-white font-medium rounded-lg hover:from-purple-300 hover:to-purple-500 transition-all duration-200 hover:shadow-lg hover:shadow-purple-500 hover:font-bold hover:text-xl"
                                            target="_blank"
